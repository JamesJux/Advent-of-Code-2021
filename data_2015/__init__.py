...
def tag2015_1(aufgabenteil):
    inputpath = "data_2015/inputs/input_2015_1.txt"
...
def tag2015_2(aufgabenteil):
    inputpath = "data_2015/inputs/input_2015_2.txt"
...
def tag2015_3(aufgabenteil):
    inputpath = "data_2015/inputs/input_2015_3.txt"
    line = openAsString(inputpath)
    # line = "<<<<>"
    nord_sued = 0
    ost_west = 0
...
def tag2015_5(aufgabenteil):
    inputpath = "data_2015/inputs/input_2015_5.txt"
    lines = openAsList(inputpath)
...
def tag2015_6_a():
    inputpath = "data_2015/inputs/input_2015_6.txt"
    lines = openAsList(inputpath)
...
def tag2015_8(aufgabenteil):
    inputpath = "data_2015/inputs/input_2015_8.txt"
    lines_list = openAsList(inputpath)
...
def tag2015_10(aufgabenteil):
    meinen_zahlstring = "3113322113"
    if aufgabenteil == 'a':
        return tag2015_10_hilfsmethode(meinen_zahlstring, 39)
    else:
        return tag2015_10_hilfsmethode(meinen_zahlstring, 49)


def tag2015_10_hilfsmethode(input, restIteration):
    output = ''
    count = 1
    ...
    if restIteration == 0:
        ...
        return tag2015_10_hilfsmethode(output, restIteration - 1)
...
def tag2015_12():
    import json
    inputpath = "data_2015/inputs/input_2015_12.txt"
